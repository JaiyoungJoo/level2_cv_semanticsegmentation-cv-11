...
def make_dataset(debug="False"):
    ...
    if args.transform=='True':
        train_dataset = XRayDataset_Multi(is_train=True, transforms=train_transform, dataclean=args.dataclean)
        valid_dataset = XRayDataset_Multi(is_train=False, transforms=val_transform, dataclean=args.dataclean)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--seed", type=int, default=70, help="random seed (default: 0), select one of [0,1,2,3,4]")
